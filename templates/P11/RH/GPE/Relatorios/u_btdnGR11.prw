...
/*
    Programa    : u_btdnGR11.PRW
    Funcao        : u_btdnGR11()
    Autor        : Marinaldo de Jesus [http://www.blacktdn.com.br]
    Data        : 17/06/2013
    Descricao    : Gerar Informacoes em Excel informações pagamento Beneficiária Pensão Alimentícia (Folha)
*/                          
User Function btdnGR11()

    Local aInfo
    Local aPerg            := Array(0)
    Local nPerg
    
    Local cFunction        := "btdnGR11"
    Local cTitle        := OemToAnsi( "Pagamento a Pensionistas (Folha)" )
    Local cDescription    := cTitle
    
    Local bProcess        := {|othis,oPanel|btdnGR11Excel(@lIsBlind,@othis,@oPanel,@cTitle)}
    ...
    BEGIN SEQUENCE
        ...
        Else
            ...
            btdnGR11Prt(@lIsBlind,@MV_PAR01,@cDescription)
        EndIF    
...
/*
    Programa    : u_btdnGR11.PRW
    Funcao        : btdnGR11Excel
    Autor        : Marinaldo de Jesus [http://www.blacktdn.com.br]
    Data        : 17/06/2013
    Descricao    : Gerar Informacoes em Excel
*/                          
Static Function btdnGR11Excel(lIsBlind,othis,oPanel,cTitle)
...
Static Function QueryView(cYearMonth,nQryCTotal,cdVencimento)
    ...
    BEGIN SEQUENCE 
        ...
        nfh     := fCreate(cDrive+"\gerador\"+cEmpAnt+"_Pagamento_a_Pensionistas_Folha_"+cYearMonth+".txt")
        lfh        := ( nfh <> -1 )
        ...
        While (cAlias)->( .NOT.( Eof() ) )
            ...
            cLine += __cTabC
            cLine += __cTabC
            cLine +=  "PENSAO ALIMENTICIA FOLHA: " + Transform( cYearMonth , "@E 9999/99")
            cLine +=  "-"
...
*/
Static Function btdnGR11Prt(lIsBlind,cYearMonth,cDescription)
