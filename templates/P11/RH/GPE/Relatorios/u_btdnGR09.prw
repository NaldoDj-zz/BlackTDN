...
/*
	Programa	: u_btdnGR09.PRW
	Funcao		: u_btdnGR09()
	Autor		: Marinaldo de Jesus [http://www.blacktdn.com.br]
	Data		: 17/06/2013
	Descricao	: Gerar Informacoes em Excel informações pagamento Sindical
*/                          
User Function btdnGR09()

	Local aInfo
	Local aPerg			:= Array(0)
	Local nPerg
	
	Local cFunction		:= "btdnGR09"
	Local cTitle		:= OemToAnsi( "Mensalidade Sindical (Verba 438)" )
	Local cDescription	:= cTitle
	
	Local bProcess		:= {|othis,oPanel|btdnGR09Excel(@lIsBlind,@othis,@oPanel,@cTitle)}
	...
	BEGIN SEQUENCE
		...
		Else
			...
			btdnGR09Prt(@lIsBlind,@MV_PAR01,@cDescription)
		EndIF	
...
/*
	Programa	: u_btdnGR09.PRW
	Funcao		: btdnGR09Excel
	Autor		: Marinaldo de Jesus [http://www.blacktdn.com.br]
	Data		: 17/06/2013
	Descricao	: Gerar Informacoes em Excel
*/                          
Static Function btdnGR09Excel(lIsBlind,othis,oPanel,cTitle)
...
Static Function QueryView(cYearMonth,nQryCTotal,cdVencimento)
	...
	BEGIN SEQUENCE
		...
		nfh 	:= fCreate(cDrive+"\gerador\"+cEmpAnt+"_mensalidade-sindical_"+cYearMonth+".txt")
		lfh		:= ( nfh <> -1 )
...
*/
Static Function btdnGR09Prt(lIsBlind,cYearMonth,cDescription)
