...
Gerado em        11/28/13 18:45:36
Observações      Código-Fonte gerado por ADVPL WSDL Client 1.120703
                 Alterações neste arquivo podem causar funcionamento incorreto
                 e serão perdidas caso o código-fonte seja gerado novamente.
=============================================================================== */

User Function _NSCVKKC ; Return  // "dummy" function - Internal Use 
...
WSMETHOD GETTRECNOSBYWHERE WSSEND cALIAS,cWHERE,nRINIT,nREND,lRDELETED,lRRECNO WSRECEIVE oWSGETTRECNOSBYWHERERESULT WSCLIENT WSUBTDNTVIEW
Local cSoap := "" , oXmlRet
...
WSSTRUCT UBTDNTVIEW_UTABLERECNOS
	WSDATA   oWSRECNOS                 AS UBTDNTVIEW_ARRAYOFINTEGER
	WSMETHOD NEW
	WSMETHOD INIT
	WSMETHOD CLONE
	WSMETHOD SOAPRECV
...
WSMETHOD CLONE WSCLIENT UBTDNTVIEW_UTABLERECNOS
	...
	oClone:oWSRECNOS            := IIF(::oWSRECNOS = NIL , NIL , ::oWSRECNOS:Clone() )
Return oClone
...
WSMETHOD SOAPRECV WSSEND oResponse WSCLIENT UBTDNTVIEW_UTABLERECNOS
	...
	::Init()
	If oResponse = NIL ; Return ; Endif 
	oNode1 :=  WSAdvValue( oResponse,"_RECNOS","ARRAYOFINTEGER",NIL,"Property oWSRECNOS as s0:ARRAYOFINTEGER on SOAP Response not found.",NIL,"O",NIL,NIL) 
	If oNode1 != NIL
		::oWSRECNOS := UBTDNTVIEW_ARRAYOFINTEGER():New()
		::oWSRECNOS:SoapRecv(oNode1)
	EndIf
Return
...
// WSDL Data Structure ARRAYOFINTEGER

WSSTRUCT UBTDNTVIEW_ARRAYOFINTEGER
	WSDATA   nINTEGER                  AS integer OPTIONAL
	WSMETHOD NEW
	WSMETHOD INIT
	WSMETHOD CLONE
	WSMETHOD SOAPRECV
...
WSMETHOD NEW WSCLIENT UBTDNTVIEW_ARRAYOFINTEGER
	::Init()
Return Self

WSMETHOD INIT WSCLIENT UBTDNTVIEW_ARRAYOFINTEGER
	::nINTEGER             := {} // Array Of  0
Return

WSMETHOD CLONE WSCLIENT UBTDNTVIEW_ARRAYOFINTEGER
	Local oClone := UBTDNTVIEW_ARRAYOFINTEGER():NEW()
	oClone:nINTEGER             := IIf(::nINTEGER <> NIL , aClone(::nINTEGER) , NIL )
Return oClone

WSMETHOD SOAPRECV WSSEND oResponse WSCLIENT UBTDNTVIEW_ARRAYOFINTEGER
	Local oNodes1 :=  WSAdvValue( oResponse,"_INTEGER","integer",{},NIL,.T.,"N",NIL,"a") 
	::Init()
	If oResponse = NIL ; Return ; Endif 
	aEval(oNodes1 , { |x| aadd(::nINTEGER ,  val(x:TEXT)  ) } )
Return
