...
WSSERVICE ubtdnTView DESCRIPTION STR0001 NAMESPACE "http://www.blacktdn.com.br" //"Obter informacoes de uma tabela do Protheus"
    ...
    WSMETHOD getTAlias                     DESCRIPTION STR0017 //"Obter Aliases validos para recuperacao de dados"
...
/*
    ...
    Autor:Marinaldo de Jesus [http://www.blacktdn.com.br]
    Data:21/11/2013
    Descricao:Obter Aliases validos para recuperacao de dados
    Uso:WebServices
*/
...
/*
    ...
    Autor:Marinaldo de Jesus [http://www.blacktdn.com.br]
    Data:21/11/2013
    Descricao:Obtem dados e estrutura da tabela baseada em condicao
    Uso:WebServices
*/
...
/*
    ...
    Autor:Marinaldo de Jesus [http://www.blacktdn.com.br]
    Data:21/11/2013
    Descricao:Obtendo os registros da Tabela baseado em condicao
    Uso:WebServices
*/
...
WSMETHOD getTablebyFieldsName WSRECEIVE Alias,rInit,rEnd,FieldsName,rDeleted,rRecno WSSEND Table WSSERVICE ubtdnTView
    ...
    TRYEXCEPTION
        ...
        IF (Empty(self:FieldsName:uFldName) .or. .NOT.(ValType(self:FieldsName:uFldName)=="A"))
            xmlGetFields(self:FieldsName)//Se entrou aqui e porque o Protheus teve dificuldades em resolver FieldsName.
        EndIF    
...
WSMETHOD getTDatabyRecnos WSRECEIVE Alias,TableRecnos,rDeleted,rRecno WSSEND TableData WSSERVICE ubtdnTView
    ...
    TRYEXCEPTION
        ...
        IF (Empty(self:TableRecnos:uRecnos) .or. .NOT.(ValType(self:TableRecnos:uRecnos)=="A"))
            xmlGetRecnos(self:TableRecnos)//Se entrou aqui e porque o Protheus teve dificuldades em resolver TableRecnos.
        EndIF    
