	...
	<body>
		<?php
			...
			try {
				...
				$fNames	   = array("RA_FILIAL","RA_MAT","RA_NOME","RA_APELIDO","RA_NOMECMP","RA_CIC","RA_ADMISSA","RA_PIS","RA_CC","RA_CATFUNC","RA_SITFOL","RA_CODFUNC");	
