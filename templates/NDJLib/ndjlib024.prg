...
CLASS NDJLIB024
    ...
    METHOD ClearCPF()
    METHOD BuildCPF(nStart,nFinish,nPlus,nStep)
    METHOD CPFChkDv(cCPF,lShowHelp)
    METHOD DvCPF(cCPF)
    METHOD DvCPF1(cCPF)
    METHOD DvCPF2(cCPF)
    METHOD NextCGC(cStart,nStart,nFinish,nPlus,nStep)
    METHOD ClearCGC() 
    METHOD BuildCGC(nStart,nFinish,nPlus,nStep)
    METHOD CGCChkDv(cCGC,lShowHelp)
    METHOD DvCGC(cCGC)
    METHOD DvCGC1(cCGC)
    METHOD DvCGC2(cCGC)
    METHOD Multiply(cNumber,aMultiply,cDirection)
    METHOD nByteSum(uNumber)
    METHOD DvMod(nMod,cNumber,aMultiply,cDirection,bGetDvMod,bAcumulator)
    METHOD DvModAcm(aDvMod)
    METHOD GetDvMod(nMod,nAccumulator)
    METHOD DvModMsR(nMod,cNumber,aMultiply,cDirection,bGetDvMod,bAcumulator)
    METHOD _DvModMsR(nMod,nAccumulator)
    METHOD DvM10b12(cNumber,cDirection)
    METHOD _DvM10b12(nMod,nAccumulator)
    METHOD Dv10b12M(cNumber,cDirection)
    METHOD Dv10b12MAcm(aDvMod)
    METHOD _Dv10b12M(nMod,nAccumulator)
    METHOD DvM11(cNumber,aMultiply,cDirection)
    METHOD DvM11P41(nMod,nAccumulator)
    METHOD DvM11b27(cNumber,cDirection)
    METHOD DvM11b29(cNumber,cDirection)    

ENDCLASS

User Function DJLIB024()
    DEFAULT oNDJLIB024:=NDJLIB024():New()
Return(oNDJLIB024)
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD NextCPF(cStart,nStart,nFinish,nPlus,nStep) CLASS NDJLIB024
RETURN(NextCPF(@cStart,@nStart,@nFinish,@nPlus,@nStep))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD ClearCPF() CLASS NDJLIB024
RETURN(ClearCPF())
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD BuildCPF(nStart,nFinish,nPlus,nStep) CLASS NDJLIB024
RETURN(BuildCPF(@nStart,@nFinish,@nPlus,@nStep))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD CPFChkDv(cCPF,lShowHelp) CLASS NDJLIB024
RETURN(CPFChkDv(@cCPF,@lShowHelp))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCPF(cCPF) CLASS NDJLIB024
RETURN(DvCPF(@cCPF))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCPF1(cCPF) CLASS NDJLIB024
RETURN(DvCPF1(@cCPF))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCPF2(cCPF) CLASS NDJLIB024
RETURN(DvCPF2(@cCPF))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD NextCGC(cStart,nStart,nFinish,nPlus,nStep) CLASS NDJLIB024
RETURN(NextCGC(@cStart,@nStart,@nFinish,@nPlus,@nStep))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD ClearCGC() CLASS NDJLIB024
RETURN(ClearCGC())
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD BuildCGC(nStart,nFinish,nPlus,nStep) CLASS NDJLIB024
RETURN(BuildCGC(@nStart,@nFinish,@nPlus,@nStep))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD CGCChkDv(cCGC,lShowHelp) CLASS NDJLIB024
RETURN(CGCChkDv(@cCGC,@lShowHelp))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCGC(cCGC) CLASS NDJLIB024
RETURN(DvCGC(@cCGC))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCGC1(cCGC) CLASS NDJLIB024
RETURN(DvCGC1(@cCGC))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvCGC2(cCGC) CLASS NDJLIB024
RETURN(DvCGC2(@cCGC))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD Multiply(cNumber,aMultiply,cDirection) CLASS NDJLIB024
RETURN(Multiply(@cNumber,@aMultiply,@cDirection))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD nByteSum(uNumber) CLASS NDJLIB024
RETURN(nByteSum(@uNumber))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvMod(nMod,cNumber,aMultiply,cDirection,bGetDvMod,bAcumulator) CLASS NDJLIB024
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvModAcm(aDvMod) CLASS NDJLIB024
RETURN(DvModAcm(@aDvMod))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD GetDvMod(nMod,nAccumulator) CLASS NDJLIB024
RETURN(GetDvMod(@nMod,@nAccumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvModMsR(nMod,cNumber,aMultiply,cDirection,bGetDvMod,bAcumulator) CLASS NDJLIB024
RETURN(DvModMsR(@nMod,@cNumber,@aMultiply,@cDirection,@bGetDvMod,@bAcumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD _DvModMsR(nMod,nAccumulator) CLASS NDJLIB024
RETURN(_DvModMsR(@nMod,@nAccumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvM10b12(cNumber,cDirection) CLASS NDJLIB024
RETURN(DvM10b12(@cNumber,@cDirection))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD _DvM10b12(nMod,nAccumulator) CLASS NDJLIB024
RETURN(_DvM10b12(@nMod,@nAccumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD Dv10b12M(cNumber,cDirection) CLASS NDJLIB024
RETURN(Dv10b12M(@cNumber,@cDirection))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD Dv10b12MAcm(aDvMod) CLASS NDJLIB024
RETURN(Dv10b12MAcm(@aDvMod))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD _Dv10b12M(nMod,nAccumulator) CLASS NDJLIB024
RETURN(_Dv10b12M(@nMod,@nAccumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvM11(cNumber,aMultiply,cDirection) CLASS NDJLIB024
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvM11P41(nMod,nAccumulator) CLASS NDJLIB024
RETURN(DvM11P41(@nMod,@nAccumulator))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvM11b27(cNumber,cDirection) CLASS NDJLIB024
RETURN(DvM11b27(@cNumber,@cDirection))
...
//------------------------------------------------------------------------------------------------
    ...
    /*/
//------------------------------------------------------------------------------------------------
METHOD DvM11b29(cNumber,cDirection) CLASS NDJLIB024
RETURN(DvM11b29(@cNumber,@cDirection))
