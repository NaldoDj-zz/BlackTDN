...
Autor:Marinaldo de Jesus
Data:01/04/2011
Descricao:Validar Acesso ao WS Considerando Usuario,Senha e CheckSum
...
Autor:Marinaldo de Jesus
Data:01/04/2011
Descricao:Verificar se Usuário Foi Autenticado
Uso:WS
/*/
...
Autor:Marinaldo de Jesus
Data:01/04/2011
Descricao:Limpa a Pilha de Mensagens
Uso:WS
/*/
...
Autor:Marinaldo de Jesus
Data:01/04/2011
Descricao:Retorna Mensagem Para Token de Autenticaco de Usuario
Uso:WS
/*/
...
/*/
    ...
    Autor:Marinaldo de Jesus
    Data:01/04/2011
    Descricao:Verifica Usuario e Senha
    Uso:Generico
/*/
...
/*/
    ...
    Autor:Marinaldo de Jesus
    Data:01/04/2011
    Descricao:Le o arqivo de Usuarios e Senhas
    Uso:Generico
/*/
...
/*/
    ...
    Autor:Marinaldo de Jesus
    Data:01/04/2011
    Descricao:Verifica se o Token venceu por TimeOut
    Uso:Generico
/*/
...
/*/
    Funcao:GetAllTokenFile
    Autor:Marinaldo de Jesus
    Data:01/04/2011
    Descricao:Obtem todos os arquivos de token
    Uso:Generico
/*/
...
/*/
    Funcao:DelAllTokenFile
    Autor:Marinaldo de Jesus
    Data:01/04/2011
    Descricao:Apaga todos os arquivos de token
    Uso:Generico
/*/
